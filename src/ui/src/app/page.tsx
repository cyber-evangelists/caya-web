/**
 * v0 by Vercel.
 * @see https://v0.dev/t/Djemq2YREem
 */
            ...
            <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16">
              <div className="flex flex-col gap-y-4">
                <h1 className="lg:leading-tighter text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-[3.4rem] 2xl:text-[3.75rem]">
                  The Future of Car Hire and Ride Sharing
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Join our community of drivers and riders to earn money from
                  your luxury cars or get a ride when needed, and experience the
                  convenience and flexibility of car hire and ride-sharing.
                </p>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  {`We're a safe and convenient platform for luxury car hire and
            ...
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our top priority is the safety of our riders and drivers.
                </p>
              </div>
              <div className="grid gap-1">
                <ClockIcon className="h-6 w-6" />
                <h3 className="text-lg font-bold">On-Demand Service</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  List your luxury cars, or get a ride when you need it, 24/7.
                </p>
              </div>
              <div className="grid gap-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Set the price for your luxury service, or choose your driver.
                </p>
              </div>
            </div>
          </div>
